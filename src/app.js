...
const centrosCostoRoutes      = require('./banks/domains/centros-costo/centros-costo.routes');
const terminalesRoutes        = require('./banks/domains/terminales/terminales.routes');
