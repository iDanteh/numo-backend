 ...
 */
async function exportarContpaqZip({ rfc, ejercicio, periodo, tipoCfdi, tipoPropuesta, modo, fechaInicio, fechaFin, formaPagoFiltro, user }) {
  ...
  let resultados;
  if (modo === 'porSucursal') {
    ({ resultados } = await generator.generarYGuardarPorSucursal({ rfc, ejercicio, periodo, tipoPropuesta, tipoCfdi, fechaInicio, fechaFin, formaPagoFiltro, user }));
  } else if (modo === 'porDia') {
    ({ resultados } = await generator.generarYGuardarPorDia({ rfc, ejercicio, periodo, tipoPropuesta, tipoCfdi, fechaInicio, fechaFin, formaPagoFiltro, user }));
  } else if (modo === 'porDiaYSucursal') {
    ({ resultados } = await generator.generarYGuardarPorSucursalYDia({ rfc, ejercicio, periodo, tipoPropuesta, tipoCfdi, fechaInicio, fechaFin, formaPagoFiltro, user }));
  } else {
