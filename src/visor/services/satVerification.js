...
const buildExpresionImpresa = (uuid, rfcEmisor, rfcReceptor, total, sello = '', version = '4.0') => {
  ...
  // RFC puede contener '&' (ej. AV&060117UX0 — persona moral con Ñ).
  // El SAT sí decodifica %26 → &, confirmado en el portal de verificación.
  // El fe NO se encoda: el SAT espera base64 literal (/, +, =).
